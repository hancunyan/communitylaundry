layui.define(['table', 'form'], function(exports) {
    ...
    //表格工具监听
    table.on('tool(LAY-knowledge-manage)', function(obj) {
        var data = obj.data;
        if (obj.event === 'del') {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if (status == 10400) {
                            ...
                            table.reload('LAY-knowledge-manage');
                        } else {
                            layer.msg("删除数据失败");
                        }
                    },
            ...
            layer.open({
                ...
                success: function(layero, index) {
                    ...
                    body.contents().find("#knowledge").val(data.knowledge);
                }
            });
